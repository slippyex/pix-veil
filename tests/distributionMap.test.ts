...
Deno.test('Distribution Map Serialization', async (t: Deno.TestContext) => {
    ...
    await t.step('should handle empty distribution map entries', () => {
    ...
    await t.step('should handle large distribution map entries', () => {
    ...
    await t.step('should handle filenames with special characters', () => {
    ...
    await t.step('should validate magic bytes during serialization and deserialization', () => {
