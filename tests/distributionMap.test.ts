...
Deno.test('should serialize and deserialize distribution map correctly', () => {
...
Deno.test('should handle empty distribution map entries', () => {
...
Deno.test('should handle large distribution map entries', () => {
...
Deno.test('should handle filenames with special characters', () => {
...
Deno.test('should validate magic bytes during serialization and deserialization', () => {
