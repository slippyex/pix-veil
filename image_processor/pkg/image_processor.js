 ...
 * @returns {Uint8Array}
 */
export function load_image_raw(png_data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(png_data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.load_image_raw(retptr, ptr0, len0);
 ...
 * @returns {any}
 */
export function get_image_metadata(png_data) {
    const ptr0 = passArray8ToWasm0(png_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_image_metadata(ptr0, len0);
 ...
 * @returns {Uint8Array}
 */
export function write_image_data(raw_data, width, height, compression_level, adaptive_filtering) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(raw_data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.write_image_data(retptr, ptr0, len0, width, height, compression_level, adaptive_filtering);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var v2 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1, 1);
